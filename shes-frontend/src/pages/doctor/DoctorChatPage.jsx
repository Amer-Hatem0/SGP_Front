...
export default function DoctorChatPage() {
  ...
  return (
    <div className="doctor-chat-page-layout"> {/* Changed main wrapper class for clarity */}
      <Navbar />
      <div className="chat-content-area"> {/* Wrapper for sidebar and main chat */}
        {/* <DoctorSidebar /> uncomment if needed based on your layout */}
        <div className="chat-page-wrapper">
          ...
          <div className="chat-main-panel">
            ...
            <div className="chat-box-fixed-header">
              Chatting with: {selectedPatientName || 'Select a patient'}
            </div>
            ...
            <div className="chat-box-scrollable-content">
              {selectedPatientId ? (
                ...
                <div className="select-patient-placeholder">
